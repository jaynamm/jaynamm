...
⚙︎ **시스템 엔지니어** 로 기상청 슈퍼컴퓨터의 시스템을 다루어보면서 리눅스를 잘 다루게 되었고  
⚙︎ **인프라 엔지니어** 로 인프라를 운영하면서 서버, 네트워크, 보안 등 여러 이슈를 경험하였고  
⚙︎ **데이터 엔지니어** 로 데이터 웨어하우스 운영과 파이프라인을 개선하고 데이터를 분석하였습니다.  
  
꾸준히 공부하고 블로그를 운영하고 있으며 Devops 분야에도 관심을 가지고 있고 개발도 재미있게 하고 있습니다. 😆  

앞으로도 더 많은 경험을 하며 성장하는 엔지니어 가 되고자 합니다. 👏   
